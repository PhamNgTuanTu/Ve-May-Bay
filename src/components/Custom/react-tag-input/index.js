...
var ReactTagInput = (function (_super) {
    ...
    function ReactTagInput() {
        ...
        _this.addTag = function (value) {
            ...
            tags.push(value);
            var arrUniqueTags = [...new Set(tags)];
            _this.props.onChange(arrUniqueTags);
    ...
    ReactTagInput.prototype.render = function () {
        ...
        var _a = this.props, tags = _a.tags, placeholder = _a.tags.length > 0 ? "" : _a.placeholder, maxTags = _a.maxTags, editable = _a.editable, readOnly = _a.readOnly, validator = _a.validator, removeOnBackspace = _a.removeOnBackspace;
        ...
        return (React.createElement("div", { className: classSelectors.wrapper },
            ...
            showInput &&
                React.createElement("input", { ref: this.inputRef, value: input, className: classSelectors.input, placeholder: placeholder, onChange: this.onInputChange, onKeyDown: this.onInputKeyDown, onBlur: this.onInputBlur })));
    };
