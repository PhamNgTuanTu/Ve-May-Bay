    ...
    return (
        <Row className='mb-3'>
            ...
            <Col md='2' className="d-flex align-items-center">
                <strong>
                    {(arrPhuTroMotChieu && arrPhuTroMotChieu[loaiHanhKhach] && arrPhuTroMotChieu[loaiHanhKhach][`${placeholder}_${loaiChuyenBay}-${index}`] ? moneyFormat(arrPhuTroMotChieu[loaiHanhKhach][`${placeholder}_${loaiChuyenBay}-${index}`].arr_phi.tong_thanh_tien) : 0) + " VNĐ"}
                </strong>
            </Col>
        </Row>
    );
