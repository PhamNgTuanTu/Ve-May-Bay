...
DichVuHaiChieuBamboo.propTypes = {};

function DichVuHaiChieuBamboo(props) {
    const { data, lengthNguoiLon, lengthTreEm, maDichVu, tendichVu, loaiChuyenBay } = props
    const { arrPhuTroHaiChieu } = useSelector(state => ({
                        ...
                        return (
                            <Row className='mb-3' key={i}>
                                ...
                                <Col md='2' className="d-flex align-items-center">
                                    <strong>
                                        {(arrPhuTroHaiChieu
                                            && arrPhuTroHaiChieu[`${val.loai_hanh_khach === "ADULT" ? "hanhKhachNguoiLon" : (val.loai_hanh_khach === "CHILD" ? "hanhKhachTreEm" : "hanhKhachEmBe")}`]
                                            && arrPhuTroHaiChieu
...
export default DichVuHaiChieuBamboo;